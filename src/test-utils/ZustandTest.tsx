/**
 * ZustandTest Component - Development utility for testing state management system
 * 
 * This component provides an interactive UI for testing all Zustand stores:
 * - nodeStore: Create nodes, manage connections, test selection
 * - uiStore: Canvas controls, panel management, notifications
 * - projectStore: Project validation, modification tracking
 * 
 * Location: test-utils/ (moved from components/ for better organization)
 */
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="panel-base">
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              ...
              <button 
                className="btn-primary text-sm"
                onClick={() => handleAddNode('capability')}
              >
                Add Capability
              </button>
              <button 
